...
<body>
    ...
    <article>
        <div class="container">
            <div class="row">
                <?php $sql = "SELECT posts.id,posts.title,categories.catname,posts.grabber,posts.creationdate FROM posts JOIN categories ON categories.id=posts.category ORDER BY posts.id DESC";
